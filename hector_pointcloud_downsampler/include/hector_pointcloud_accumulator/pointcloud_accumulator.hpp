...
public:
  ...
  void publishNewPointsPointcloud();
...
protected:
  ...
  sensor_msgs::msg::PointCloud2 new_points_cloud_;

  tf2_ros::Buffer tfBuffer;
  tf2_ros::TransformListener tfListener;

  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr accumulated_publisher_;
  rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr new_points_publisher_;

  std::vector<rclcpp::Subscription<sensor_msgs::msg::PointCloud2>::SharedPtr> pointcloud_subscriptions_;
  rclcpp::TimerBase::SharedPtr accumulated_publish_timer_;
  rclcpp::TimerBase::SharedPtr new_points_publish_timer_;
