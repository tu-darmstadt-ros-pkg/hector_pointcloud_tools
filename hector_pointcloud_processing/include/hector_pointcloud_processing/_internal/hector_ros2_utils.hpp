 ...
 *
 * @param node The node the parameter is declared on. Must outlive the returned subscription.
...
[[nodiscard]] ParameterSubscription createReconfigurableParameter(
    NodeT &node, const std::string &name, std::reference_wrapper<ParameterT> param,
